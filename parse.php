...
while (true) {
    try {
        ...
        if ($movie->isValid($article->node)) {
            ...
            //get imdb mapping
            $imdbId = ltrim($movie->getImdb($article->node), '0');
